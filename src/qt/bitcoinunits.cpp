...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case CRP: return QString("Cranepays");
    case mCRP: return QString("Milli-Cranepays (1 / 1" THIN_SP_UTF8 "000)");
    case uCRP: return QString("Micro-Cranepays (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
