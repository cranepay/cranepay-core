...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " cranepay-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  cranepay-tx [options] <hex-tx> [commands]  Update hex-encoded cranepay transaction\n" +
            "or:     cranepay-tx [options] -create [commands]   Create hex-encoded cranepay transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cranepay transaction
