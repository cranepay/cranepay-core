...
const char * const BITCOIN_CONF_FILENAME = "cranepay.conf";
const char * const BITCOIN_PID_FILENAME = "cranepayd.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Cranepay";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Cranepay";
#else
    // Unix
    return pathRet / ".cranepay";
#endif
#endif
}
