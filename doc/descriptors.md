# Support for Output Descriptors in Cranepay Core

Since Cranepay Core v2.0.0, there is support for Output Descriptors in the
...
on Cranepay's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Cranepay Core wallets, a convenience function `combo` is
